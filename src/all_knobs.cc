...
all_knobs_c::all_knobs_c() {
	...
	KNOB_SIAQ_SIZE = new KnobTemplate< uns32 > ("siaq_size", 32);
	...
	KNOB_SIAQ_MEDIUM_SIZE = new KnobTemplate< uns32 > ("siaq_medium_size", 32, "siaq_size");
	...
	KNOB_SIAQ_LARGE_SIZE = new KnobTemplate< uns32 > ("siaq_large_size", 32, "siaq_size");
	...
	KNOB_LLC_THROUGHPUT = new KnobTemplate< int > ("llc_throughput", 16);
	KNOB_L2_CLOCKRATE = new KnobTemplate< float > ("l2_clockrate", 3.4);
	KNOB_LLC_CLOCKRATE = new KnobTemplate< float > ("llc_clockrate", 0.85);
	...
	KNOB_CORE_THREAD_SCHED = new KnobTemplate< string > ("core_thread_sched", "greedy");
	KNOB_UOP_LATENCY_MAP = new KnobTemplate< string > ("uop_latency_map", "x86");
	...
	KNOB_DEBUG_MMU = new KnobTemplate< bool > ("debug_mmu", false);
	KNOB_DEBUG_TLB = new KnobTemplate< bool > ("debug_tlb", false);
	...
	KNOB_CLOCK_LLC = new KnobTemplate< float > ("clock_llc", 1.0);
	...
	KNOB_LLC_READ_PORTS = new KnobTemplate< int > ("llc_read_ports", 1);
	...
	KNOB_LLC_WRITE_PORTS = new KnobTemplate< int > ("llc_write_ports", 1);
	...
	KNOB_NUM_LLC = new KnobTemplate< int > ("num_llc", 1);
	KNOB_LLC_INTERLEAVE_FACTOR = new KnobTemplate< int > ("llc_interleave_factor", 64);
	KNOB_LLC_NUM_SET = new KnobTemplate< int > ("llc_num_set", 8192);
	KNOB_LLC_ASSOC = new KnobTemplate< int > ("llc_assoc", 16);
	KNOB_LLC_LINE_SIZE = new KnobTemplate< int > ("llc_line_size", 64);
	KNOB_LLC_NUM_BANK = new KnobTemplate< int > ("llc_num_bank", 16);
	KNOB_LLC_LATENCY = new KnobTemplate< int > ("llc_latency", 25);
	...
	KNOB_MEMORY_TYPE = new KnobTemplate< string > ("memory_type", "llc_cn");
	...
	KNOB_PAGE_SIZE = new KnobTemplate< long > ("page_size", 4096);
	KNOB_REGION_SIZE = new KnobTemplate< long > ("region_size", 1048576);
	KNOB_MEMORY_SIZE = new KnobTemplate< long > ("memory_size", 4294967296);
	...
	KNOB_TLB_NUM_ENTRY = new KnobTemplate< long > ("tlb_num_entry", 2048);
	KNOB_PAGE_TABLE_WALK_LATENCY = new KnobTemplate< long > ("page_table_walk_latency", 200);
	KNOB_PAGE_FAULT_LATENCY = new KnobTemplate< long > ("page_fault_latency", 1000);
	KNOB_PAGE_EVICTION_LATENCY = new KnobTemplate< long > ("page_eviction_latency", 1000);
	KNOB_BATCH_PROCESSING_OVERHEAD = new KnobTemplate< long > ("batch_processing_overhead", 50000);
	KNOB_FAULT_BUFFER_SIZE = new KnobTemplate< long > ("fault_buffer_size", 512);
	...
	KNOB_RAMULATOR_CONFIG_FILE = new KnobTemplate< string > ("ramulator_config_file", "../src/ramulator/configs/DDR4-config.cfg");
	...
	KNOB_SSCHED_SIZE = new KnobTemplate< uns16 > ("ssched_size", 32);
	...
	KNOB_SSCHED_MEDIUM_SIZE = new KnobTemplate< uns16 > ("ssched_medium_size", 32, "ssched_size");
	...
	KNOB_SSCHED_LARGE_SIZE = new KnobTemplate< uns16 > ("ssched_large_size", 32, "ssched_size");
	...
	KNOB_SSCHED_RATE = new KnobTemplate< uns16 > ("ssched_rate", 1);
	...
	KNOB_SSCHED_MEDIUM_RATE = new KnobTemplate< uns16 > ("ssched_medium_rate", 1, "ssched_rate");
	...
	KNOB_SSCHED_LARGE_RATE = new KnobTemplate< uns16 > ("ssched_large_rate", 1, "ssched_rate");
...
all_knobs_c::~all_knobs_c() {
	...
	delete KNOB_LLC_THROUGHPUT;
	delete KNOB_L2_CLOCKRATE;
	delete KNOB_LLC_CLOCKRATE;
	...
	delete KNOB_CORE_THREAD_SCHED;
	delete KNOB_UOP_LATENCY_MAP;
	...
	delete KNOB_DEBUG_MMU;
	delete KNOB_DEBUG_TLB;
	...
	delete KNOB_NUM_LLC;
	delete KNOB_LLC_INTERLEAVE_FACTOR;
	delete KNOB_LLC_NUM_SET;
	delete KNOB_LLC_ASSOC;
	delete KNOB_LLC_LINE_SIZE;
	delete KNOB_LLC_NUM_BANK;
	delete KNOB_LLC_LATENCY;
	...
	delete KNOB_MEMORY_SIZE;
	delete KNOB_PAGE_MAPPING_POLICY;
	delete KNOB_USE_MEMHIERARCHY;
	delete KNOB_USE_VAULTSIM_LINK;
	delete KNOB_TLB_NUM_ENTRY;
	delete KNOB_PAGE_TABLE_WALK_LATENCY;
	delete KNOB_PAGE_FAULT_LATENCY;
	delete KNOB_PAGE_EVICTION_LATENCY;
	delete KNOB_BATCH_PROCESSING_OVERHEAD;
	delete KNOB_FAULT_BUFFER_SIZE;
...
void all_knobs_c::registerKnobs(KnobsContainer *container) {
	...
	container->insertKnob( KNOB_SIAQ_SIZE );
	...
	container->insertKnob( KNOB_SIAQ_MEDIUM_SIZE );
	...
	container->insertKnob( KNOB_SIAQ_LARGE_SIZE );
	...
	container->insertKnob( KNOB_LLC_THROUGHPUT );
	container->insertKnob( KNOB_L2_CLOCKRATE );
	container->insertKnob( KNOB_LLC_CLOCKRATE );
	...
	container->insertKnob( KNOB_CORE_THREAD_SCHED );
	container->insertKnob( KNOB_UOP_LATENCY_MAP );
	...
	container->insertKnob( KNOB_DEBUG_MMU );
	container->insertKnob( KNOB_DEBUG_TLB );
	...
	container->insertKnob( KNOB_CLOCK_LLC );
	...
	container->insertKnob( KNOB_NUM_LLC );
	container->insertKnob( KNOB_LLC_INTERLEAVE_FACTOR );
	container->insertKnob( KNOB_LLC_NUM_SET );
	container->insertKnob( KNOB_LLC_ASSOC );
	container->insertKnob( KNOB_LLC_LINE_SIZE );
	container->insertKnob( KNOB_LLC_NUM_BANK );
	container->insertKnob( KNOB_LLC_LATENCY );
	...
	container->insertKnob( KNOB_MEMORY_SIZE );
	...
	container->insertKnob( KNOB_TLB_NUM_ENTRY );
	container->insertKnob( KNOB_PAGE_TABLE_WALK_LATENCY );
	container->insertKnob( KNOB_PAGE_FAULT_LATENCY );
	container->insertKnob( KNOB_PAGE_EVICTION_LATENCY );
	container->insertKnob( KNOB_BATCH_PROCESSING_OVERHEAD );
	container->insertKnob( KNOB_FAULT_BUFFER_SIZE );
	...
	container->insertKnob( KNOB_SSCHED_SIZE );
	...
	container->insertKnob( KNOB_SSCHED_MEDIUM_SIZE );
	...
	container->insertKnob( KNOB_SSCHED_MEDIUM_RATE );
	...
	container->insertKnob( KNOB_SSCHED_LARGE_RATE );
