...
class all_knobs_c {
	...
	// Added for AMX instructions. One tileloadd instruction should be able to load 1KB.
		...
		KnobTemplate< bool >* KNOB_AMX_WL_BP;
		KnobTemplate< bool >* KNOB_AMX_WL_S;
		KnobTemplate< bool >* KNOB_AMX_WL_PIPE;
		KnobTemplate< int >* KNOB_AMX_WL_LATENCY;
	...
	// =========== ../def/core.param.def ===========
		...
		KnobTemplate< int >* KNOB_LLC_THROUGHPUT;
		KnobTemplate< float >* KNOB_L2_CLOCKRATE;
		KnobTemplate< float >* KNOB_LLC_CLOCKRATE;
		...
		KnobTemplate< string >* KNOB_CORE_THREAD_SCHED;
		KnobTemplate< string >* KNOB_UOP_LATENCY_MAP;
	...
	// =========== ../def/debug.param.def ===========
		...
		KnobTemplate< bool >* KNOB_DEBUG_MMU;
		KnobTemplate< bool >* KNOB_DEBUG_TLB;
	...
	// =========== ../def/general.param.def ===========
		...
		KnobTemplate< float >* KNOB_CLOCK_LLC;
	...
	// =========== ../def/memory.param.def ===========
		...
		KnobTemplate< int >* KNOB_NUM_LLC;
		KnobTemplate< int >* KNOB_LLC_INTERLEAVE_FACTOR;
		KnobTemplate< int >* KNOB_LLC_NUM_SET;
		KnobTemplate< int >* KNOB_LLC_ASSOC;
		KnobTemplate< int >* KNOB_LLC_LINE_SIZE;
		KnobTemplate< int >* KNOB_LLC_NUM_BANK;
		KnobTemplate< int >* KNOB_LLC_LATENCY;
		...
		KnobTemplate< long >* KNOB_PAGE_SIZE;
		KnobTemplate< long >* KNOB_REGION_SIZE;
		KnobTemplate< long >* KNOB_MEMORY_SIZE;
		...
		KnobTemplate< long >* KNOB_TLB_NUM_ENTRY;
		KnobTemplate< long >* KNOB_PAGE_TABLE_WALK_LATENCY;
		KnobTemplate< long >* KNOB_PAGE_FAULT_LATENCY;
		KnobTemplate< long >* KNOB_PAGE_EVICTION_LATENCY;
		KnobTemplate< long >* KNOB_BATCH_PROCESSING_OVERHEAD;
		KnobTemplate< long >* KNOB_FAULT_BUFFER_SIZE;
	...
	// =========== ../def/schedule.param.def ===========
		...
		KnobTemplate< uns16 >* KNOB_SSCHED_SIZE;
		...
		KnobTemplate< uns16 >* KNOB_SSCHED_MEDIUM_SIZE;
		...
		KnobTemplate< uns16 >* KNOB_SSCHED_MEDIUM_RATE;
		...
		KnobTemplate< uns16 >* KNOB_SSCHED_LARGE_RATE;
